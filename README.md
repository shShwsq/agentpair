...
- **Executor abstraction layer**: Pluggable executors — built-in ReAct agent / Qoder CLI / Kimi Code CLI / Hermes CLI / Codex CLI — unified via the ACP protocol
...
- **Multi Git platform**: Unified abstraction layer supporting GitHub / Gitee — OAuth login + private repo binding + automatic cloning
...
│   ├── app/
│   │   ├── agents/           # Agents (user_agent / react_agent / orchestrator)
│   │   ├── llm/              # LLM client wrappers
│   │   ├── models/           # SQLAlchemy data models
│   │   ├── routers/          # API routes (auth / tasks / git_provider / ...)
│   │   ├── sandbox/          # OpenSandbox client wrapper
│   │   ├── scenarios/        # Scenario templates (security audit / code review)
│   │   ├── schemas/          # Pydantic request/response models
│   │   ├── skills/           # Skill loader + skill registry
│   │   ├── tools/            # ReAct tools (clone_repo / search_code / ...)
